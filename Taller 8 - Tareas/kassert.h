...
#define kassert(X, MSG)                                                        \
  if (!(X)) {                                                                  \
    screen_draw_box(0, 0, 5, 80, 0x00, C_FG_LIGHT_GREEN | C_BG_BLACK);        \
    print("ASSERTION FAILED", 1, 1, C_FG_LIGHT_GREEN | C_BG_BLACK);            \
    print(MSG, 1, 3, C_FG_LIGHT_GREEN | C_BG_BLACK);                           \
    while (1) {                                                                \
      __asm volatile("nop");                                                   \
    }                                                                          \
  }
